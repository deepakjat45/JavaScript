...
//     })
//     .catch((err) => {
//         console.log("promise was reject, error :", err);
//     });
...
// async function demo() {
//     await getNum(); // await se ek kam hone par dusara suru hoga
//     await getNum(); 
//     await getNum();  
//     await getNum();
//     await getNum();
...
// let Data = JSON.parse(json_Response);  //json.parse json data ko js object me converte kar deta he 
// console.log(Data.fact); 


//API testing tools
// what is Ajax   //very less use now
//Http verbs
// States code
